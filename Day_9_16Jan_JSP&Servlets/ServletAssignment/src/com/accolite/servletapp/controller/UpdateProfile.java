	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
				...
				if(nname!=null && password1!=null && ucity!=null) {
					...
					String sql = "update userTable set nickname='"+nname+"',city='"+ucity+"', passwordValue='"+password1+"' where username='"+user_name+"'"; 
					st.executeUpdate(sql);
					
					
					
					
					String msg = "updated user details succefully as follows:  ";
					request.setAttribute("message", msg +""+ user_name + " nickname: "+ nname+ " city: "+ ucity);
